...
CREATE TABLE bookings (
	...
	room_types_id int4 NOT NULL,
	dates daterange NOT NULL,
	CONSTRAINT bookings_pk PRIMARY KEY (id)
);
ALTER TABLE bookings ADD CONSTRAINT bookings_room_types_fk FOREIGN KEY (room_types_id) REFERENCES room_types(id);
ALTER TABLE bookings ADD CONSTRAINT bookings_cities_fk FOREIGN KEY (city_id) REFERENCES cities(id);
INSERT INTO bookings(id,city_id,room_types_id,dates) VALUES(1,3,2,'[2020-01-01,2030-01-01)');